               ...
               <div class="col-lg-12">
                  <div class="nos-offres owl-carousel">
                     <div class="single-offre bg-7 bg">
                        ...
                        <div class="row h-100">
                           <div
                              class="col mt-auto pl-4 pb-2 text-white position-relative"
                           >
                              <p>haut atlas</p>
                              <h3>Trip au grand atlas</h3>
                              <a href="" class="clean-a">
                                 <img
                                    src="./assets/img/home/btn-play-video.png"
                                    width=""
                                    alt=""
                                 />
                                 Explorer
               ...
               <div class="col-lg-12">
                  <div class="font-confiance owl-carousel">
                     <div class="font-confiance-inner bg">
                        <div class="">
                           <img
                              class="quet-image mx-auto"
                              src="./assets/img/home/quote-icon.png"
                              width="30px"
                              alt=""
                           />
                           ...
                           <img
                              class="face-image mx-auto mb-3"
                              src="./assets/img/home/img-notre-programe.jpg"
                              alt=""
                           />
         ...
         <div class="container p-0 px-2">
            ...
            <div class="row mt-5">
               ...
               <div class="col-lg-6 pb-3 pt-4 pt-lg-0">
                  ...
                  <p>
                     <strong
                        >en cas de voyage de 2 groupes de 14 personnes= 28
                        personnes</strong
                     >
                  </p>
                  <p class="pb-4">
                  ...
                  <div class="row">
                     <a href="" class="primary-btn mx-3 my-1"
            ...
            <div class="row contact-sec">
               ...
               <div
                  class="col-lg-5 row mx-0 contact-right-side bg p-4 text-white"
               >
                  <div class="col-12">
                     <h3 class="mb-4">Contact Information</h3>
                     <img
                        src="./assets/img/home/icon-adresse.png"
                        class="d-inline"
                        alt=""
                     />
                     Adresse
                  ...
                  <div class="col-12 mt-auto">
                     <p class="mb-0 d-inline float-right">
                        ...
                        <a href="">
                           <img
                              class="ml-3"
                              src="./assets/img/home/icon-facebook.png"
                              alt=""
                           />
                        </a>
                        <a href="">
                           <img
                              src="./assets/img/home/icon-instagram.png"
                              alt=""
                           />
                        </a>
                     </p>
